...
/**
 * Job: hello Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class hello implements TalendJob {
	...
	private final String projectName = "MAVEN_TEST";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(hello.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final hello helloClass = new hello();

		int exitCode = helloClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = hello.class.getClassLoader()
					.getResourceAsStream(
							"maven_test/hello_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : hello");
		}
...
/************************************************************************************************
 * 20539 characters generated by Talend Open Studio for Data Integration on the
 * May 22, 2017 6:00:11 PM IST
 ************************************************************************************************/
